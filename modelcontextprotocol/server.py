...
def search_assets_tool(
    ...
    This tool replaces the older DSL-based search (get_assets_by_dsl_tool).
    Use conditions, negative_conditions, and some_conditions for complex logical filtering
    instead of raw Elasticsearch DSL.
